...
from src.utils.utils import create_zip_buffer
...
# ==================== CRM - SETUP PAGE ====================
    ...
    # Example: assuming you have a folder named 'my_data' in your app's directory
    # In a real app, this data might be generated by user actions or backend processes
    folder_to_zip = "data"

    # Generate the zip buffer
    zip_data = create_zip_buffer(folder_to_zip)

    # Display the download button
    st.download_button(
        label="Download data Folder as ZIP",
        data=zip_data,
        file_name="data.zip",
